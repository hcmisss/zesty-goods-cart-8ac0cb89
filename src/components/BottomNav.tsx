...
const BottomNav = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 h-20 bg-background/70 backdrop-blur-lg border-t border-border/50 flex justify-around items-center px-4 z-40">
      {navItems.map((item) => {
