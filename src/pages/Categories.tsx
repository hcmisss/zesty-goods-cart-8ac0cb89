...
const Categories = () => {
  ...
  return <div className="animated-background min-h-screen pb-24">
      ...
      <main className="flex-1 overflow-y-auto p-4">
        <h2 className="text-2xl font-bold mb-6 text-center text-slate-50">دسته‌بندی‌ها</h2>
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4">
          {categories.map(category => <div key={category.id} className="group cursor-pointer overflow-hidden rounded-2xl bg-card/70 backdrop-blur-sm border border-border/50 shadow-lg transition-all hover:scale-105">
