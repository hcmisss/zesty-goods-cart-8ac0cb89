...
const Orders = () => {
  ...
  if (loading) {
    return <div className="min-h-screen animated-background flex items-center justify-center">
  ...
  return <div className="relative min-h-screen w-full flex-col overflow-x-hidden pb-32">
      ...
      <main className="flex flex-col gap-4 p-4">
        {loading ? <div className="flex items-center justify-center py-20">
          ...
          </div> : orders.length === 0 ? <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <Button onClick={() => navigate("/")} className="bg-primary text-white hover:bg-primary/90">
          ...
          </div> : orders.map(order => <div key={order.id} className="flex flex-col items-stretch justify-start rounded-lg shadow-[0_2px_8px_rgba(0,0,0,0.08)] bg-card/70 backdrop-blur-lg border border-border/50 p-4 space-y-4">
              ...
              <div className="border-t border-border pt-3">
                <p className="text-foreground text-sm mb-2 font-bold">آدرس تحویل:</p>
              ...
              {order.order_items && order.order_items.length > 0 && <div className="border-t border-border pt-3">
                  ...
                  <div className="space-y-2 text-lg">
                    {order.order_items.map((item: any, index: number) => <div key={index} className="flex justify-between items-center text-sm">
                        <span className="text-foreground/80 font-extrabold text-lg">
